...
$(document).ready(function (e) {
    ...
    // Save album
    $(document).on('click', '.save-add-general-album', function (e2) {
    ...
    $(document).on('click', '.save-add-general-genre', function (e2) {
        let textElement = e2.target.parentNode.parentNode.parentNode.querySelector('input[type="text"]');
        e2.preventDefault();
        $.ajax({
    ...
    $(document).on('click', '.save-add-general-artist', function (e2) {
        let textElement = e2.target.parentNode.parentNode.parentNode.querySelector('input[type="text"]');
        e2.preventDefault();
        $.ajax({
