...
function initModal()
{
    ...
    albumModalSelector = document.querySelector('#addAlbumDialog');
    albumModal = new bootstrap.Modal(albumModalSelector, {
        keyboard: false
    });

    genreModalSelector = document.querySelector('#addGenreDialog');
    genreModal = new bootstrap.Modal(genreModalSelector, {
        keyboard: false
    });

    artistModalSelector = document.querySelector('#addArtistDialog');
...
$(document).ready(function (e) {
    ...
    $(document).on('click', '.button-upload-file', function (e1) {
        ...
        downloadForm('.lazy-dom', function(){
            if(!allDownloaded)
            {
                initModal();
                allDownloaded = true;
